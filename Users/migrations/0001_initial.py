    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateـofـbirth', models.DateTimeField(auto_created=True, verbose_name='Date of birth')),
                ...
                ('role', models.CharField(choices=[('derakhti', 'derakhti'), ('mlm', 'mlm'), ('taksathi', 'taksathi')], max_length=50, verbose_name='Rols')),
