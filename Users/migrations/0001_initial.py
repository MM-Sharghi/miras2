    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('mard', 'mard'), ('zan', 'zan')], max_length=999, verbose_name='Gender ')),
                ('role', models.CharField(blank=True, choices=[('derakhti', 'derakhti'), ('mlm', 'mlm'), ('taksathi', 'taksathi'), ('taksathiAdmin', 'taksathiAdmin')], max_length=50, null=True, verbose_name='Rols')),
                ('national_code', models.CharField(max_length=999, unique=True, verbose_name='National Code ')),
                ('mobile1', models.CharField(max_length=999, verbose_name='Mobile 1')),
                ('marital_status', models.CharField(choices=[('motahel', 'motahel'), ('mojarad', 'mojarad')], max_length=999, verbose_name='Marital status')),
                ('education', models.CharField(choices=[('diplom', 'diplom'), ('lisans', 'lisans')], max_length=999, verbose_name='Education')),
