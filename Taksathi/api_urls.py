...
urlpatterns = [
    ...
    path('tak-s-admin-panel/products/products-main_categories/', api_views.admin_main_categories.as_view(), name='admin_main_categories'),
    path('tak-s-admin-panel/products/products-sub_categories1/', api_views.admin_sub_categories1.as_view(), name='admin_sub_categories1'),
    path('tak-s-admin-panel/products/products-sub_categories2/', api_views.admin_sub_categories2.as_view(), name='admin_sub_categories2'),
